...
function HeroCardComp({ lightHeaderText, boldHeaderText, description }) {
  return (
    <div className="w-full lg:w-[600px] p-6 h-full relative">
      ...
      <p className="capitalize text-5xl lg:text-6xl z-10 relative">{lightHeaderText} </p>
      <p className="text-5xl lg:text-6xl font-bold mt-1 mb-2 capitalize relative">{boldHeaderText}</p>
