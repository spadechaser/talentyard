    ...
    return (
        <div >
            <div className="min-h-[500px] lg:min-h-[670px] w-full bg-contain bg-no-repeat flex flex-col justify-center space-y-12 lg:justify-start items-center relative">
                ...
                <div className=''></div>
                <div className='z-10 mt-24 flex flex-col space-y-24 items-center h-full absolute'>
                    <div className=''>
                        <HeroCardComp boldHeaderText={"Hire Talent"} lightHeaderText={"Fastest way to"} description={"Nulla mollit esse deserunt velit veniam amet adipisicing aliquip eiusmod sint id proident proident."} />
                    </div>
                    <div className='z-10'>
