    ...
    return (
        <div className='flex flex-col text-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-4 my-12'>
            ...
            <div className='flex flex-col lg:flex-row items-center shadow-lg'>
                <div className='w-1/3 bg-accentSecondary/30 min-h-[300px] border-r-[1px] border-black flex flex-col justify-start items-start p-6 text-left transition ease-in-out delay-100 hover:-translate-y-1 duration-300 hover:shadow-lg hover:cursor-pointer rounded-l-xl'>
                ...
                <div className='w-1/3 bg-accentSecondary/30 min-h-[300px] border-r-[0.5px] border-black flex flex-col justify-start items-start p-6 text-left transition ease-in-out delay-100 hover:-translate-y-1 duration-300 hover:shadow-lg hover:cursor-pointer'>
                    <PencilIcon width={100} height={100} strokeWidth={0.5} />
                    <h3 className='text-2xl font-extralight'>Designers</h3>
                    <p className='text-base font-extralight'>Nostrud ex cupidatat nulla culpa exercitation tempor elit. Sit ut enim velit excepteur minim dolore qui labore duis. Nisi fugiat ipsum nulla veniam sint excepteur cupidatat laboris ullamco.</p>
                </div>
                <div className='w-1/3 bg-accentSecondary/30 min-h-[300px] border-l-[0.5px] border-black flex flex-col justify-start items-start p-6 text-left transition ease-in-out delay-100 hover:-translate-y-1 duration-300 hover:shadow-lg hover:cursor-pointer rounded-r-xl'>
